...
<div class="parallax-window" data-parallax="scroll" data-image-src="images/gearstshirt.jpg" data-position="center center" data-speed="0.7"></div>

<!--#redirect-wrap creates a horizontal banner with some text and a button to redirect viewer to another page-->
<div id="redirect-wrap">
	<div id="redirect-text">
		<h3 class="sub-font">
			 Deep Blue Shop Has Launched!
			</h3>
	</div>
	<div id="redirect-btn">
...
<div class="parallax-window" data-parallax="scroll" data-image-src="images/sponsorspic.jpg" data-position="center center" data-speed="0.7"></div>
...
<div id="redirect-wrap">
	<div id="redirect-text">
		<h3 class="sub-font">
			 Follow us on social media so you don't miss a pic!
			</h3>
	</div>
	<div id="redirect-btn">
