<?php /* Smarty version Smarty-3.1.13, created on 2015-12-04 01:27:57
         compiled from "/home/dbrobotic/public_html/colab/templates/standard/adminprojects.tpl" */ ?>
<?php /*%%SmartyHeaderCode:51560416356615c9de1e531-35694467%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcbe8fd9cf622a305990b878f3bb164375f81ec2' => 
    array (
      0 => '/home/dbrobotic/public_html/colab/templates/standard/adminprojects.tpl',
      1 => 1414597114,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '51560416356615c9de1e531-35694467',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56615c9e0cb1d2_00499718',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56615c9e0cb1d2_00499718')) {function content_56615c9e0cb1d2_00499718($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/home/dbrobotic/public_html/colab/include/plugins/modifier.truncate.php';
...
/images/symbols/user-icon-male.png" alt="" />
					<?php echo $_smarty_tpl->getConfigVariable('userwasdeassigned');?>
...
/images/symbols/projects.png" alt="" />
					<?php echo $_smarty_tpl->getConfigVariable('projectwasadded');?>
			...
			<div class="headline">
				...
				<div class="wintools">
					<a class="add" href="javascript:blindtoggle('form_addmyproject');" id="add_myprojects" onclick="toggleClass(this,'add-active','add');toggleClass('add_butn_myprojects','butn_link_active','butn_link');toggleClass('sm_myprojects','smooth','nosmooth');">
						<span><?php echo $_smarty_tpl->getConfigVariable('addproject');?>
</span>
					</a>
				</div>
				<?php }?>
...
/theme/<?php echo $_smarty_tpl->tpl_vars['settings']->value['theme'];?>
/images/symbols/projects.png" alt="" />
					<?php echo $_smarty_tpl->getConfigVariable('openprojects');?>
...
"></a>
									...
									<td>
										<div class="toggle-in">
											<span id="adminprojectstoggle<?php echo $_smarty_tpl->tpl_vars['opros']->value[$_smarty_tpl->getVariable('smarty')->value['section']['opro']['index']]['ID'];?>
" class="acc-toggle" onclick="javascript:accord_projects.activate($$('#acc-projects .accordion_toggle')[<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['opro']['index'];?>
...
">
									<?php }?>
										...
										<tr>
											<td class="a">
												<?php if ($_smarty_tpl->tpl_vars['userpermissions']->value['projects']['add']){?>
												<a class="butn_checked" href="manageproject.php?action=open&amp;id=<?php echo $_smarty_tpl->tpl_vars['clopros']->value[$_smarty_tpl->getVariable('smarty')->value['section']['clopro']['index']]['ID'];?>
				...
				<div class="tablemenue">
					<div class="tablemenue-in">
						...
						<a class="butn_link" href="javascript:blindtoggle('form_addmyproject');" id="add_butn_myprojects" onclick="toggleClass('add_myprojects','add-active','add');toggleClass(this,'butn_link_active','butn_link');toggleClass('sm_myprojects','smooth','nosmooth');">
							<?php echo $_smarty_tpl->getConfigVariable('addproject');?>
						...
						<a class="butn_link" href="javascript:blindtoggle('doneblock');" id="donebutn" onclick="toggleClass(this,'butn_link_active','butn_link');toggleClass('toggle-done','acc-toggle','acc-toggle-active');">
							<?php echo $_smarty_tpl->getConfigVariable('closedprojects');?>
